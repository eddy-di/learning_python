...
# function that randomly choses a word from list
def get_word():
...
def display_hangman(tries):
    stages = [  # index 0, финальное состояние: голова, торс, обе руки, обе ноги
                '''
                   --------
                   |      |
                   |      O
                   ...
                   -
                ''',
                # index 1, голова, торс, обе руки, одна нога
                '''
                   --------
                   |      |
                   |      O
                ...
                '''
                   ...
                   -
                ''',
                # index 3, голова, торс и одна рука
                '''
                   --------
                   |      |
                   |      O
